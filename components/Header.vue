<template>
  <header id="site-header" class="site-header" role="banner">
    <div id="title-container" class="title-container">
      <div id="site-title" class="site-title">
        <nuxt-link to="/">
          ...
          <img
            class="logo"
            src="/images/moco_logo1.png"
            alt="Movement &amp; Computing"
            scale="0"
          />
        </nuxt-link>
      </div>
    ...
    >
      <div
        id="menu-primary"
        class="menu-container menu-primary"
        role="navigation"
      >
        <nav class="menu">
      ...
      <ul class="social-media-icons">
        <li>
          <a
            class="twitter"
            target="_blank"
            href="https://twitter.com/MOCO_Conference"
          >
            <svg
              width="30"
              height="30"
        ...
        <li>
          <a
            class="email"
            target="_blank"
            href="https://groups.google.com/forum/#!forum/movementcomputing"
          >
            <svg
              style="
                margin-top: -5px;
